...
<div id="warp_main">
  ...
  <div class="main_about">
    ...
    <div class="main_about_box clearfix ">
      <div id="example-one">
        <ul class="nav">
          <li class="nav-one"><a href="<?php echo leuu('list/index',array('id'=>3));?>" <?php if($term_id == 3): ?>class="current"<?php endif; ?>>公司新闻</a></li>
          <li class="nav-one"><a href="<?php echo leuu('list/index',array('id'=>4));?>" <?php if($term_id == 4): ?>class="current"<?php endif; ?>>行业新闻</a></li>
        </ul>
        <div class="list-wrap">
          <ul id="featured">
            <div class="news_box clearfix">
              <div class="n_box_r">
                <div class="news_deta clearfix">
                  <div class="deta_new">
                    <h3><?php echo ($post_title); ?></h3>
                    <div class="new_tim"><span><?php echo ($post_date); ?></span>&nbsp;&nbsp;<span>来源：<?php echo ($post_source); ?></span></div>
                    <div class="new_con"> <?php echo ($post_content); ?> </div>
                  </div>
                  <div class="news_page">
                    <ul>
                      <?php if(!empty($prev)): ?><li><a href="<?php echo leuu('article/index',array('id'=>$prev['object_id'],'cid'=>$prev['term_id']));?>" class="btn btn-primary pull-left">上一篇：<?php echo ($prev['post_title']); ?></a></li><?php endif; ?>
                      <?php if(!empty($next)): ?><li><a href="<?php echo leuu('article/index',array('id'=>$next['object_id'],'cid'=>$next['term_id']));?>" class="btn btn-warning pull-right">下一篇：<?php echo ($next['post_title']); ?></a></li><?php endif; ?>
                    </ul>
                  </div>
                </div>
              </div>
